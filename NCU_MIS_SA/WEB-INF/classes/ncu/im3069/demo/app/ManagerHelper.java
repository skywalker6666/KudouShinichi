...
public class ManagerHelper {
    ...
    public JSONObject getByNamePassword(String name,String password) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`tbl_manager` WHERE `managerName` = ? ";
            ...
            while(rs.next()) {
                ...
                /** 將 ResultSet 之資料取出 */
                int member_id = rs.getInt("idtbl_manager");
                String _name = rs.getString("managerName");
                String _password = rs.getString("managerPassword");
                int isLeader = rs.getInt("isLeader");
                int isDeleted = rs.getInt("isDeleted");
                ...
                mg = new Manager(member_id, _name, _password, isLeader, isDeleted);
